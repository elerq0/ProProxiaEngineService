...
namespace ProxiaEngineService.OptimaAPI
{
    public class Optima
    {
        ...
        public OP_CSRSLib.SrsZlecenie CreateZlecenie()
        {
            try
            {
                return optimaSession.session.CreateObject("CDN.SrsZlecenia").AddNew();
            }
            catch (Exception e)
            {
                throw new Exception("Błąd przy tworzeniu zlecenia serwisowego [" + e.Message + "]");
            }
        }
